// Test: does a TAB key press wake the app's focus system?
using System;
...
class TabTest
{
    ...
    static int Main()
    {
        ...
        Console.WriteLine("before: hwndFocus=0x" + gi.hwndFocus.ToString("X"));
        ...
        GetGUIThreadInfo(tid, ref gi);
        Console.WriteLine("after TAB: hwndFocus=0x" + gi.hwndFocus.ToString("X"));
        ...
        Console.WriteLine("click row1 -> chat pane diff = " + d.ToString("F1"));
        Console.WriteLine(d > 6 ? "SUCCESS" : "FAIL");
